...
function PAR = ak_fixed_wireless_set_parameters_outdoor_channelsL19(scenario_idx)
...
switch scenario_idx
    ...
    case 0 % default PAR
        ...
        PAR.coord_pattern = 1;  %use 1 if num_cell = 19 and 2 if 7
