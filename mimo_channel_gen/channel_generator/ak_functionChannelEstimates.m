function [Hhat_MMSE,C_MMSE,R,H,Hhat_EW_MMSE,C_EW_MMSE,Hhat_LS,C_LS] = ak_functionChannelEstimates(R,channelGaindB,nbrOfRealizations,M,K,L,p,f,tau_p)
%% AK: make tau_p an input, not output parameter
...
%tau_p = f*K; %made tau_p an input, not output parameter
...
elseif f == L %Only works in the running example with its 16 BSs
