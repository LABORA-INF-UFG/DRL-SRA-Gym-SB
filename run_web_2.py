...
env = SRAEnv(gamma=1.0, alpha=1.0, beta=0.0)
env.running_tp = 0

model = DQN(CustomLnMlpPolicy, env, verbose=0, gamma=0.9, learning_rate=0.007)

folder = 'E:/Docs_Doutorado/models_new_dataset3/'


F = "_F_2-2_" + env.tf_folder_acr + "_g1_a1_b0"
base_file = F + "_gamma_09_lr_007_epsilon_1e-5_9_custon_policy"

# training # time steps
ts = 100000

model.learn(total_timesteps=ts)
model.save(folder + F + base_file)
