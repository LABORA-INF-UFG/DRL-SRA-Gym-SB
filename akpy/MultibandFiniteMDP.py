'''
This code is different from MultibandFiniteMDPToyExample, because it does not assume knowledge of the correct
nextStateProbability.
'''
import numpy as np
import itertools
import sys
from akpy.FiniteMDP import FiniteMDP
...
if __name__ == '__main__':
    ...
    mdp.prettyPrint()
    if False:
        action_values, iteration = mdp.compute_optimal_action_values() #we don't know the actual transitions probabilities
    else:
        action_values, rewardsQLearning = mdp.execute_q_learning(maxNumIterations=1000, maxNumIterationsQLearning = 1,
