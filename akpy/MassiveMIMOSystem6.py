...
class MassiveMIMOSystem:
    def __init__(self, K=3, frequency_index=1, ti=0):
        #depends on dataset
        #self.num_episodes = 200 ## 200 for new data
        # controling the traffic interference dataset
        self.ti = ti
    ...
    def load_episode(self, episode_number):
        ...
        file_name = self.root_folder + '/traffic_interference_validation/v'+ str(self.ti) +'/traffic_interference_e_' + str(episode_number+1) + '.mat'
