...
class Buffers:
    ...
    def create_buffers(self, buffer_sizes):
        ...
        self.last_arrive = [0. for i in range(self.num_buffers)]
    ...
    def packets_arrival(self, num_incoming_packets):
        ...
        self.last_arrive = num_incoming_packets
    ...
    def get_buffer_states(self):
        return (self.buffer_occupancies, self.oldest_packet_per_buffer(), self.last_arrive)
